...
sed -e "s|<releases>|<releases>$RELEASE_OPENING_TAG$DESCRIPTION_OPENING_TAG$LIST_OPENING_TAG$CHANGELOG$LIST_CLOSING_TAG$DESCRIPTION_CLOSING_TAG$RELEASE_CLOSING_TAG|g" -i utilities/texstudio.appdata.xml
